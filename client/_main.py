...
from src.interfaces.influx import get_df
from src.interfaces.magic_eden import popular_collections
...
app.title = "Magic Eden Edge"
app.description = "MagicEden Trading Insights And Data"
...
header = html.Div(
    children=[
        ...
        html.H3(children='Dark Matter Labs',
...
collections = get_collection_symbols(popular_collections())
measurements = [
    "listed_count",
    "price_floor"
]
...
layout = html.Div(
    children=[
        ...
        dbc.Row(
            [
                dbc.Col(children=[
                    html.H2("Collections", style={'fontSize': '1.3em'}),
                    dcc.Dropdown(
                        collections, 
                        collections[0], 
...
def update_collection_selection(
    ...
    interval: str,
    options: list):
    print("collection_id {}".format(collection_ids))
    print("measurement", measurements)
    print("interval", interval)
    print("options: {}".format(options))

    # silly framwork sometimes returns a string
    # sometimes a []string. So let's just make it 
    # a []string
